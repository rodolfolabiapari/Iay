; ModuleID = 'numerical_recipes_main.1.bc'
...
; <label>:8                                       ; preds = %._crit_edge23, %.lr.ph26
  ...
  %nprev.024 = phi i32 [ 1, %.lr.ph26 ], [ %12, %._crit_edge23 ]
  %9 = mul i32 %indvar32, -1
  %10 = add i32 %ndim, %9
  %scevgep35 = getelementptr [4 x i32]* %nn, i32 0, i32 %10
  %11 = load i32* %scevgep35, align 4, !tbaa !1
  %12 = mul i32 %11, %nprev.024
  %13 = udiv i32 %.lcssa, %12
  %14 = shl i32 %nprev.024, 1
  %15 = mul i32 %11, %14
  %16 = mul i32 %15, %13
  %17 = icmp eq i32 %15, 0
  br i1 %17, label %.preheader5, label %.lr.ph12

.lr.ph12:                                         ; preds = %8
  %18 = add i32 %14, -2
  %19 = mul i32 %nprev.024, 2
  %20 = mul i32 %19, %11
  %21 = mul i32 %nprev.024, 2
  %22 = mul i32 %nprev.024, 2
  %23 = mul i32 %22, %11
  %24 = add i32 %23, 1
  %25 = add i32 %22, 1
  br label %30

.preheader5.loopexit:                             ; preds = %61
  br label %.preheader5

.preheader5:                                      ; preds = %.preheader5.loopexit, %8
  %26 = icmp ult i32 %14, %15
  br i1 %26, label %.lr.ph22.preheader, label %._crit_edge23

.lr.ph22.preheader:                               ; preds = %.preheader5
  %27 = mul i32 %nprev.024, 2
  %28 = add i32 %27, 1
  %29 = add i32 %27, -1
  br label %.lr.ph22

; <label>:30                                      ; preds = %61, %.lr.ph12
  %indvar3 = phi i32 [ %indvar.next4, %61 ], [ 0, %.lr.ph12 ]
  %i2rev.09 = phi i32 [ 1, %.lr.ph12 ], [ %62, %61 ]
  %31 = mul i32 %21, %indvar3
  %32 = add i32 %31, 3
  %33 = add i32 %24, %31
  %34 = add i32 %31, 2
  %i2.010 = add i32 %31, 1
  %35 = add i32 %25, %31
  %36 = icmp ugt i32 %i2rev.09, %i2.010
  br i1 %36, label %.preheader4, label %.preheader3.preheader

.preheader4:                                      ; preds = %30
  %overflow_intrinsic = zext i32 %18 to i33
...
.preheader2.lr.ph:                                ; preds = %.preheader4
  %37 = add i32 %i2rev.09, 1
  br label %.preheader2

.preheader2:                                      ; preds = %._crit_edge, %.preheader2.lr.ph
  %indvar1 = phi i32 [ %indvar.next2, %._crit_edge ], [ 0, %.preheader2.lr.ph ]
  %38 = mul i32 %indvar1, 2
  %39 = add i32 %32, %38
  %40 = add i32 %33, %38
  %41 = add i32 %34, %38
  %i1.08 = add i32 %i2.010, %38
  %42 = mul i32 %indvar1, 2
  %43 = add i32 %i2rev.09, %42
  %44 = add i32 %37, %42
  %45 = icmp ugt i32 %i1.08, %16
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader
  ...
  %46 = mul i32 %23, %indvar
  %47 = add i32 %40, %46
  %48 = add i32 %41, %46
  %scevgep = getelementptr [134 x float]* %data, i32 0, i32 %48
  %49 = add i32 %i1.08, %46
  %scevgep5 = getelementptr [134 x float]* %data, i32 0, i32 %49
  %50 = mul i32 %20, %indvar
  %51 = add i32 %43, %50
  %scevgep7 = getelementptr [134 x float]* %data, i32 0, i32 %51
  %52 = add i32 %44, %50
  %scevgep6 = getelementptr [134 x float]* %data, i32 0, i32 %52
  %53 = load float* %scevgep5, align 4, !tbaa !5
  %54 = load float* %scevgep7, align 4, !tbaa !5
  store float %54, float* %scevgep5, align 4, !tbaa !5
  store float %53, float* %scevgep7, align 4, !tbaa !5
  %55 = load float* %scevgep, align 4, !tbaa !5
  %56 = load float* %scevgep6, align 4, !tbaa !5
  store float %56, float* %scevgep, align 4, !tbaa !5
  store float %55, float* %scevgep6, align 4, !tbaa !5
  %57 = icmp ugt i32 %47, %16
  %indvar.next = add i32 %indvar, 1
  br i1 %57, label %._crit_edge.loopexit, label %.lr.ph

._crit_edge.loopexit:                             ; preds = %.lr.ph
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader2
  %58 = icmp ugt i32 %39, %overflow_intrinsic_sum
  %indvar.next2 = add i32 %indvar1, 1
  br i1 %58, label %.preheader3.preheader.loopexit, label %.preheader2

.preheader3.preheader.loopexit:                   ; preds = %._crit_edge
  br label %.preheader3.preheader

.preheader3.preheader:                            ; preds = %.preheader3.preheader.loopexit, %.preheader4, %30
  br label %.preheader3

.preheader3:                                      ; preds = %.preheader3, %.preheader3.preheader
  %ibit.0.in = phi i32 [ %ibit.0, %.preheader3 ], [ %15, %.preheader3.preheader ]
  %i2rev.1 = phi i32 [ %60, %.preheader3 ], [ %i2rev.09, %.preheader3.preheader ]
  %ibit.0 = lshr i32 %ibit.0.in, 1
  %59 = icmp ugt i32 %i2rev.1, %ibit.0
  %not. = icmp uge i32 %ibit.0, %14
  %. = and i1 %59, %not.
  %60 = sub i32 %i2rev.1, %ibit.0
  br i1 %., label %.preheader3, label %61

; <label>:61                                      ; preds = %.preheader3
  %ibit.0.lcssa = phi i32 [ %ibit.0, %.preheader3 ]
  %i2rev.1.lcssa = phi i32 [ %i2rev.1, %.preheader3 ]
  %62 = add i32 %i2rev.1.lcssa, %ibit.0.lcssa
  %63 = icmp ugt i32 %35, %15
  %indvar.next4 = add i32 %indvar3, 1
  br i1 %63, label %.preheader5.loopexit, label %30

.loopexit.loopexit:                               ; preds = %._crit_edge17
  br label %.loopexit

.loopexit:                                        ; preds = %.lr.ph22, %.loopexit.loopexit
  %64 = icmp ult i32 %65, %15
  br i1 %64, label %.lr.ph22, label %._crit_edge23.loopexit

.lr.ph22:                                         ; preds = %.loopexit, %.lr.ph22.preheader
  %ifp1.021 = phi i32 [ %65, %.loopexit ], [ %14, %.lr.ph22.preheader ]
  %65 = shl i32 %ifp1.021, 1
  %66 = udiv i32 %65, %14
  %67 = uitofp i32 %66 to double
  %68 = fdiv double %5, %67
  %69 = fptrunc double %68 to float
  %70 = fmul float %69, 5.000000e-01
  %71 = tail call float @sinf(float %70) #4
  %72 = fpext float %71 to double
  %73 = fmul double %72, -2.000000e+00
  %74 = fmul double %72, %73
  %75 = fptrunc double %74 to float
  %76 = tail call float @sinf(float %69) #4
  %77 = icmp eq i32 %ifp1.021, 0
  br i1 %77, label %.loopexit, label %.preheader1.preheader

.preheader1.preheader:                            ; preds = %.lr.ph22
  %78 = add i32 %ifp1.021, 2
  %79 = add i32 %ifp1.021, 1
  %80 = mul i32 %ifp1.021, 2
  %81 = add i32 %80, 1
  br label %.preheader1

.preheader1:                                      ; preds = %._crit_edge17, %.preheader1.preheader
  %indvar18 = phi i32 [ %indvar.next19, %._crit_edge17 ], [ 0, %.preheader1.preheader ]
  %wr.020 = phi float [ %125, %._crit_edge17 ], [ 1.000000e+00, %.preheader1.preheader ]
  %wi.019 = phi float [ %129, %._crit_edge17 ], [ 0.000000e+00, %.preheader1.preheader ]
  %82 = mul i32 %27, %indvar18
  %83 = add i32 %82, 3
  %84 = add i32 %81, %82
  %85 = add i32 %82, 2
  %i3.118 = add i32 %82, 1
  ...
  %88 = add i32 %28, %82
  %89 = add i32 %29, %82
  %90 = icmp ugt i32 %i3.118, %89
  br i1 %90, label %._crit_edge17, label %.preheader.preheader
...
.preheader:                                       ; preds = %._crit_edge15, %.preheader.preheader
  ...
  %91 = mul i32 %indvar16, 2
  %92 = add i32 %83, %91
  %93 = add i32 %84, %91
  %94 = add i32 %85, %91
  %i1.116 = add i32 %i3.118, %91
  %95 = add i32 %86, %91
  %96 = add i32 %87, %91
  %97 = icmp ugt i32 %i1.116, %16
  br i1 %97, label %._crit_edge15, label %.lr.ph14.preheader
...
.lr.ph14:                                         ; preds = %.lr.ph14, %.lr.ph14.preheader
  ...
  %98 = mul i32 %80, %indvar14
  %99 = add i32 %93, %98
  %100 = add i32 %94, %98
  %scevgep20 = getelementptr [134 x float]* %data, i32 0, i32 %100
  %101 = add i32 %i1.116, %98
  %scevgep21 = getelementptr [134 x float]* %data, i32 0, i32 %101
  %102 = add i32 %95, %98
  %scevgep22 = getelementptr [134 x float]* %data, i32 0, i32 %102
  %103 = add i32 %96, %98
  %scevgep23 = getelementptr [134 x float]* %data, i32 0, i32 %103
  %104 = load float* %scevgep23, align 4, !tbaa !5
  %105 = fmul float %wr.020, %104
  %106 = load float* %scevgep22, align 4, !tbaa !5
  %107 = fmul float %wi.019, %106
  %108 = fsub float %105, %107
  %109 = fmul float %wr.020, %106
  %110 = fmul float %wi.019, %104
  %111 = fadd float %110, %109
  %112 = load float* %scevgep21, align 4, !tbaa !5
  %113 = fsub float %112, %108
  store float %113, float* %scevgep23, align 4, !tbaa !5
  %114 = load float* %scevgep20, align 4, !tbaa !5
  %115 = fsub float %114, %111
  store float %115, float* %scevgep22, align 4, !tbaa !5
  %116 = load float* %scevgep21, align 4, !tbaa !5
  %117 = fadd float %108, %116
  store float %117, float* %scevgep21, align 4, !tbaa !5
  %118 = load float* %scevgep20, align 4, !tbaa !5
  %119 = fadd float %111, %118
  store float %119, float* %scevgep20, align 4, !tbaa !5
  %120 = icmp ugt i32 %99, %16
  %indvar.next15 = add i32 %indvar14, 1
  br i1 %120, label %._crit_edge15.loopexit, label %.lr.ph14

._crit_edge15.loopexit:                           ; preds = %.lr.ph14
  br label %._crit_edge15

._crit_edge15:                                    ; preds = %._crit_edge15.loopexit, %.preheader
  %121 = icmp ugt i32 %92, %89
  %indvar.next17 = add i32 %indvar16, 1
  br i1 %121, label %._crit_edge17.loopexit, label %.preheader

._crit_edge17.loopexit:                           ; preds = %._crit_edge15
  br label %._crit_edge17

._crit_edge17:                                    ; preds = %._crit_edge17.loopexit, %.preheader1
  %122 = fmul float %75, %wr.020
  %123 = fmul float %76, %wi.019
  %124 = fsub float %122, %123
  %125 = fadd float %wr.020, %124
  %126 = fmul float %75, %wi.019
  %127 = fmul float %76, %wr.020
  %128 = fadd float %126, %127
  %129 = fadd float %wi.019, %128
  %130 = icmp ugt i32 %88, %ifp1.021
  %indvar.next19 = add i32 %indvar18, 1
  br i1 %130, label %.loopexit.loopexit, label %.preheader1
...
._crit_edge23:                                    ; preds = %._crit_edge23.loopexit, %.preheader5
  ...
  %exitcond34 = icmp ne i32 %indvar.next33, %ndim
  br i1 %exitcond34, label %8, label %._crit_edge27.loopexit
