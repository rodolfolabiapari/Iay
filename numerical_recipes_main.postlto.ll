; ModuleID = 'numerical_recipes_main.postlto.bc'
...
.lr.ph31:                                         ; preds = %.lr.ph31, %.lr.ph31.preheader
  %idim.029 = phi i32 [ %9, %.lr.ph31 ], [ 1, %.lr.ph31.preheader ]
  %ntot.028 = phi i32 [ %8, %.lr.ph31 ], [ 1, %.lr.ph31.preheader ]
  %6 = getelementptr inbounds [4 x i32]* %nn, i32 0, i32 %idim.029
  %7 = load i32* %6, align 4, !tbaa !1
  %8 = mul i32 %7, %ntot.028
  %9 = add nsw i32 %idim.029, 1
  %exitcond = icmp eq i32 %idim.029, %ndim
  br i1 %exitcond, label %.preheader6, label %.lr.ph31

; <label>:10                                      ; preds = %._crit_edge23, %.lr.ph26
  %idim.125 = phi i32 [ %ndim, %.lr.ph26 ], [ %100, %._crit_edge23 ]
  %nprev.024 = phi i32 [ 1, %.lr.ph26 ], [ %13, %._crit_edge23 ]
  %11 = getelementptr inbounds [4 x i32]* %nn, i32 0, i32 %idim.125
  %12 = load i32* %11, align 4, !tbaa !1
  %13 = mul i32 %12, %nprev.024
  %14 = udiv i32 %8, %13
  %15 = shl i32 %nprev.024, 1
  %16 = mul i32 %12, %15
  %17 = mul i32 %16, %14
  %18 = icmp eq i32 %16, 0
  br i1 %18, label %.preheader5, label %.lr.ph12
...
.preheader5:                                      ; preds = %.preheader5.loopexit, %10
  %20 = icmp ult i32 %15, %16
  br i1 %20, label %.lr.ph22.preheader, label %._crit_edge23

.lr.ph22.preheader:                               ; preds = %.preheader5
  br label %.lr.ph22

; <label>:21                                      ; preds = %42, %.lr.ph12
  %i2.010 = phi i32 [ 1, %.lr.ph12 ], [ %44, %42 ]
  %i2rev.09 = phi i32 [ 1, %.lr.ph12 ], [ %43, %42 ]
  %22 = icmp ugt i32 %i2rev.09, %i2.010
  br i1 %22, label %.preheader4, label %.preheader3.preheader

.preheader4:                                      ; preds = %21
  %overflow_intrinsic = zext i32 %19 to i33
...
.preheader2.lr.ph:                                ; preds = %.preheader4
  %23 = sub i32 %i2rev.09, %i2.010
  br label %.preheader2

.preheader2:                                      ; preds = %._crit_edge, %.preheader2.lr.ph
  %i1.08 = phi i32 [ %i2.010, %.preheader2.lr.ph ], [ %38, %._crit_edge ]
  %24 = icmp ugt i32 %i1.08, %17
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader
  %i3.07 = phi i32 [ %36, %.lr.ph ], [ %i1.08, %.lr.ph.preheader ]
  %25 = add i32 %23, %i3.07
  %26 = getelementptr inbounds [134 x float]* %data, i32 0, i32 %i3.07
  %27 = load float* %26, align 4, !tbaa !5
  %28 = getelementptr inbounds [134 x float]* %data, i32 0, i32 %25
  %29 = load float* %28, align 4, !tbaa !5
  store float %29, float* %26, align 4, !tbaa !5
  store float %27, float* %28, align 4, !tbaa !5
  %30 = add i32 %i3.07, 1
  %31 = getelementptr inbounds [134 x float]* %data, i32 0, i32 %30
  %32 = load float* %31, align 4, !tbaa !5
  %33 = add i32 %25, 1
  %34 = getelementptr inbounds [134 x float]* %data, i32 0, i32 %33
  %35 = load float* %34, align 4, !tbaa !5
  store float %35, float* %31, align 4, !tbaa !5
  store float %32, float* %34, align 4, !tbaa !5
  %36 = add i32 %i3.07, %16
  %37 = icmp ugt i32 %36, %17
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader2
  %38 = add i32 %i1.08, 2
  %39 = icmp ugt i32 %38, %overflow_intrinsic_sum
  br i1 %39, label %.preheader3.preheader.loopexit, label %.preheader2

.preheader3.preheader.loopexit:                   ; preds = %._crit_edge
  br label %.preheader3.preheader

.preheader3.preheader:                            ; preds = %.preheader3.preheader.loopexit, %.preheader4, %21
  br label %.preheader3

.preheader3:                                      ; preds = %.preheader3, %.preheader3.preheader
  %ibit.0.in = phi i32 [ %ibit.0, %.preheader3 ], [ %16, %.preheader3.preheader ]
  %i2rev.1 = phi i32 [ %41, %.preheader3 ], [ %i2rev.09, %.preheader3.preheader ]
  %ibit.0 = lshr i32 %ibit.0.in, 1
  %40 = icmp ugt i32 %i2rev.1, %ibit.0
  %not. = icmp uge i32 %ibit.0, %15
  %. = and i1 %40, %not.
  %41 = sub i32 %i2rev.1, %ibit.0
  br i1 %., label %.preheader3, label %42

; <label>:42                                      ; preds = %.preheader3
  %43 = add i32 %i2rev.1, %ibit.0
  %44 = add i32 %i2.010, %15
  %45 = icmp ugt i32 %44, %16
  br i1 %45, label %.preheader5.loopexit, label %21

.loopexit.loopexit:                               ; preds = %._crit_edge17
  br label %.loopexit

.loopexit:                                        ; preds = %.lr.ph22, %.loopexit.loopexit
  %46 = icmp ult i32 %47, %16
  br i1 %46, label %.lr.ph22, label %._crit_edge23.loopexit

.lr.ph22:                                         ; preds = %.loopexit, %.lr.ph22.preheader
  %ifp1.021 = phi i32 [ %47, %.loopexit ], [ %15, %.lr.ph22.preheader ]
  %47 = shl i32 %ifp1.021, 1
  %48 = udiv i32 %47, %15
  %49 = uitofp i32 %48 to double
  %50 = fdiv double %5, %49
  %51 = fptrunc double %50 to float
  %52 = fmul float %51, 5.000000e-01
  %53 = tail call float @sinf(float %52) #4
  %54 = fpext float %53 to double
  %55 = fmul double %54, -2.000000e+00
  %56 = fmul double %54, %55
  %57 = fptrunc double %56 to float
  %58 = tail call float @sinf(float %51) #4
  %59 = icmp eq i32 %ifp1.021, 0
  br i1 %59, label %.loopexit, label %.preheader1.preheader

.preheader1.preheader:                            ; preds = %.lr.ph22
  br label %.preheader1

.preheader1:                                      ; preds = %._crit_edge17, %.preheader1.preheader
  %wr.020 = phi float [ %94, %._crit_edge17 ], [ 1.000000e+00, %.preheader1.preheader ]
  %wi.019 = phi float [ %98, %._crit_edge17 ], [ 0.000000e+00, %.preheader1.preheader ]
  %i3.118 = phi i32 [ %60, %._crit_edge17 ], [ 1, %.preheader1.preheader ]
  %60 = add i32 %i3.118, %15
  %61 = add i32 %60, -2
  %62 = icmp ugt i32 %i3.118, %61
  br i1 %62, label %._crit_edge17, label %.preheader.preheader

.preheader.preheader:                             ; preds = %.preheader1
  br label %.preheader

.preheader:                                       ; preds = %._crit_edge15, %.preheader.preheader
  %i1.116 = phi i32 [ %89, %._crit_edge15 ], [ %i3.118, %.preheader.preheader ]
  %63 = icmp ugt i32 %i1.116, %17
  br i1 %63, label %._crit_edge15, label %.lr.ph14.preheader

.lr.ph14.preheader:                               ; preds = %.preheader
  br label %.lr.ph14

.lr.ph14:                                         ; preds = %.lr.ph14, %.lr.ph14.preheader
  %i2.113 = phi i32 [ %87, %.lr.ph14 ], [ %i1.116, %.lr.ph14.preheader ]
  %64 = add i32 %i2.113, %ifp1.021
  %65 = getelementptr inbounds [134 x float]* %data, i32 0, i32 %64
  %66 = load float* %65, align 4, !tbaa !5
  %67 = fmul float %wr.020, %66
  %68 = add i32 %64, 1
  %69 = getelementptr inbounds [134 x float]* %data, i32 0, i32 %68
  %70 = load float* %69, align 4, !tbaa !5
  %71 = fmul float %wi.019, %70
  %72 = fsub float %67, %71
  %73 = fmul float %wr.020, %70
  %74 = fmul float %wi.019, %66
  %75 = fadd float %74, %73
  %76 = getelementptr inbounds [134 x float]* %data, i32 0, i32 %i2.113
  %77 = load float* %76, align 4, !tbaa !5
  %78 = fsub float %77, %72
  store float %78, float* %65, align 4, !tbaa !5
  %79 = add i32 %i2.113, 1
  %80 = getelementptr inbounds [134 x float]* %data, i32 0, i32 %79
  %81 = load float* %80, align 4, !tbaa !5
  %82 = fsub float %81, %75
  store float %82, float* %69, align 4, !tbaa !5
  %83 = load float* %76, align 4, !tbaa !5
  %84 = fadd float %72, %83
  store float %84, float* %76, align 4, !tbaa !5
  %85 = load float* %80, align 4, !tbaa !5
  %86 = fadd float %75, %85
  store float %86, float* %80, align 4, !tbaa !5
  %87 = add i32 %i2.113, %47
  %88 = icmp ugt i32 %87, %17
  br i1 %88, label %._crit_edge15.loopexit, label %.lr.ph14
...
._crit_edge15:                                    ; preds = %._crit_edge15.loopexit, %.preheader
  %89 = add i32 %i1.116, 2
  %90 = icmp ugt i32 %89, %61
  br i1 %90, label %._crit_edge17.loopexit, label %.preheader

._crit_edge17.loopexit:                           ; preds = %._crit_edge15
  br label %._crit_edge17

._crit_edge17:                                    ; preds = %._crit_edge17.loopexit, %.preheader1
  %91 = fmul float %57, %wr.020
  %92 = fmul float %58, %wi.019
  %93 = fsub float %91, %92
  %94 = fadd float %wr.020, %93
  %95 = fmul float %57, %wi.019
  %96 = fmul float %58, %wr.020
  %97 = fadd float %95, %96
  %98 = fadd float %wi.019, %97
  %99 = icmp ugt i32 %60, %ifp1.021
  br i1 %99, label %.loopexit.loopexit, label %.preheader1

._crit_edge23.loopexit:                           ; preds = %.loopexit
  br label %._crit_edge23

._crit_edge23:                                    ; preds = %._crit_edge23.loopexit, %.preheader5
  %100 = add nsw i32 %idim.125, -1
  %101 = icmp sgt i32 %100, 0
  br i1 %101, label %10, label %._crit_edge27.loopexit
