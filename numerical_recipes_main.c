...
float data[4][512][512], speq[2][2 * 512];
...
void fourn(unsigned long nn[], int ndim, int isign)
{
  int idim;
...
void rlft3(unsigned long heigth, unsigned long width,
...
int main(void)
{
  ...
  // PNG
  int img_width = 256, img_height = 256, img_depth = 4;
  ...
  printf("rlft3-1\n");
  rlft3(1, img_height, img_width, 1);
